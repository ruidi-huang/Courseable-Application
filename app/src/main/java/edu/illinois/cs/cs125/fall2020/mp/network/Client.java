  ...
  public void getSummary(
    ...
    StringRequest summaryRequest =
        new StringRequest(
            ...
            response -> {
              try {
                Summary[] courses = mapper.readValue(response, Summary[].class);
  ...
  public void getCourse(
    ...
    StringRequest courseRequest =
            new StringRequest(
                    ...
                    response -> {
                      try {
                        Course course = mapper.readValue(response, Course.class);
  ...
  public void getRating(
    ...
    StringRequest ratingRequest =
            new StringRequest(
                    ...
                    response -> {
                      try {
                        Rating rating = mapper.readValue(response, Rating.class);
  ...
  public void postRating(
    ...
    StringRequest ratingRequest =
            new StringRequest(
                    ...
                    response -> {
                      try {
                        Rating r = mapper.readValue(response, Rating.class);
      ...
      public byte[] getBody() throws AuthFailureError {
        try {
          String ratingPost = mapper.writeValueAsString(rating);
          return ratingPost.getBytes();
        } catch (JsonProcessingException e) {
          e.printStackTrace();
        }
        return "I am not alone".getBytes();
      }
    };
    requestQueue.add(ratingRequest);
  }
